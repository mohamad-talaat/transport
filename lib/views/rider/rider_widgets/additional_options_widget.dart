...
class AdditionalOptionsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (!mapController.showAdditionalOptions.value) {
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    GestureDetector(
                      onTap: () => mapController.toggleAdditionalOptions(),
                      child: Icon(
                        Icons.close,
                ...
                child: Column(
                  children: [
                    ...
                    _buildOptionTile(
                      ...
                      color: Colors.orange,
                      onTap: () {
                        if (mapController.additionalStops.length >= mapController.maxAdditionalStops.value) {
                          Get.snackbar(
                            'تحذير',
                        ...
                        } else if (!mapController.isPickupConfirmed.value || !mapController.isDestinationConfirmed.value) {
                          Get.snackbar(
                            'تنبيه',
                        ...
                        mapController.toggleAdditionalOptions();
                      },
                    ),
                    ...
                    // Show current stops count
                    if (mapController.additionalStops.isNotEmpty) ...[
                      _buildInfoTile(
                        icon: Icons.location_on,
                        title: 'المحطات الوسطية',
                        subtitle: '${mapController.additionalStops.length} محطة',
                        color: Colors.green,
                      ),
                      const SizedBox(height: 8),
                    ],
  ...
  void _showClearStopsDialog(BuildContext context, MapControllerr mapController) {
    showDialog(
      context: context,
  ...
  void _showResetDialog(BuildContext context, MapControllerr mapController) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Row(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              // Use the reset function from MapController
