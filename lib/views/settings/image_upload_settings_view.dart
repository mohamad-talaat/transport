...
import '../../services/smart_image_service.dart';
...
class ImageUploadSettingsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final SmartImageService imageService = Get.find<SmartImageService>();
  ...
  Widget _buildMethodSelection(SmartImageService imageService) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildMethodOption(
    SmartImageService imageService,
  ...
  Widget _buildTestSection(SmartImageService imageService) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  void _testImageUpload(SmartImageService imageService) async {
    try {
  ...
  void _clearAllImages(SmartImageService imageService) async {
